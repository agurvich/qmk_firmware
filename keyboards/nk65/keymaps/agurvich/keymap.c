...
[1] = LAYOUT_65_ansi( /* FN */
    ...
    KC_TRNS, KC_MPLY, KC_MNXT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS,\
...
//              "00AF 005C 005F 0028 30C4 0029 005F 002F 00AF");
        ...
        case ABGDEBUG:
            if (record->event.pressed) {
                ...
                g_config.color_1.h = (g_config.color_1.h+1) % 256;
            } else {
